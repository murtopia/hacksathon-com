...
export function ShowcaseTeaser({
  ...
  return (
    <section className="relative overflow-hidden border-b bg-gradient-to-b from-muted/60 to-background">
      <div className="container mx-auto max-w-3xl px-4 py-24 text-center sm:py-32">
        ...
        <div className="mt-10 inline-flex items-center gap-2 rounded-full border bg-background px-4 py-2 text-sm font-medium shadow-sm">
