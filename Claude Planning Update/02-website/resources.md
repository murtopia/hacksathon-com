...
Purpose:
Defines the Resources page (public name: Resource Library): structure, locked page copy, launch content roadmap, and the long-term authority-engine strategy.
...
- 00-home/project-memory.md (original resource idea list)
- 06-research/participant-reflections.md (raw material for stories)

Used By:
- Resources page
- Content production planning
- Social syndication (X, LinkedIn)
- SEO strategy
...
- Internal Pillar Taxonomy (living)
...
The job of Resources is trust and authority, not selling. The homepage sells, The Program explains, How It Works teaches, Resources builds trust. Long-term vision: the definitive resource on Organizational AI Adoption and the publishing engine of the company.
...
5. **Small library with a pulse beats empty library with ambition.** Launch with the Seven2 story, 2-3 field notes, and 1-2 anchor articles; grow on the roadmap below. Same proof-gated rule as Built For verticals: a category appears publicly when it has content.
6. **No gated content at launch.** The ungated stance is a trust flex. When templates arrive post-launch as the single gated lead magnet, the contrast makes one gate feel fair.
7. **Resources must not delay the Product Hunt launch.** It is a post-launch growth engine with a minimum-viable launch state.

## Locked Page Copy

Approved by Nick 2026-07-06.
...
2. AI Confidence vs. AI Literacy (a settled internal distinction; mostly transcription)

**I'm leading a team**
3. Why AI Adoption Fails (executive thought-leadership anchor)
4. How to Run an Internal AI Hacks-a-Thon (best SEO asset: captures DIY searchers, shows the platform does it better)

**I want to create**
5. How to Pick Your First AI Project (the passion-project philosophy)
6. Giving Design Direction to AI (from the Seven2 research: the #1 friction point for creative teams; reference-site method, vibe descriptions, iterate-from-first-output, design-first tools)

**I want proof**
7. The Seven2 Story (already exists on the live site)
8. One participant story (edit from participant-reflections.md, not written from scratch)

**Field Notes cadence (ongoing)**
Formats: what surprised me this week / a workflow I can't stop using / a mistake I made so you don't have to / a tool that wasn't worth the hype / one prompt that changed how I work / what I'm seeing inside organizations. Twenty-minute writes. Each note syndicates to X and LinkedIn with a link back.

## Internal Pillar Taxonomy

For planning and tagging only. Never public navigation.

1. AI Adoption (executive thought leadership)
2. Psychology (why people resist, why creation builds confidence, why personal projects work, overcoming overwhelm, shared creation and culture)
3. Practical Guides (evergreen, searchable how-tos)
4. Templates & Downloads (post-launch lead magnets)
5. Customer Stories (stories, not case studies; humans connect with stories)
6. Product Spotlights (Inside the IdeaLab, Why We Built Blueprint, How the Hacky Helper Runs Your Event, Behind the Hacky Awards, Why Reflection Matters. CORRECTED: the ChatGPT brain dump proposed "How the Playbook Works"; the Playbook does not exist and was removed from the site 2026-07-06.)
7. Videos (future YouTube strategy: five-minute lessons, participant interviews, walkthroughs, build-with-me)
8. Research (participant data, adoption findings)
9. AI Field Notes (Nick's ongoing voice; distribution engine)

## Post-Launch Roadmap

In priority order after launch:

1. **Templates & Downloads** as the first gated lead magnet (Organizer Checklist, Project Planning Worksheet, Prompt Templates, Reflection Worksheet). Needs design time; deliberately excluded from launch scope.
2. Fill remaining launch-roadmap articles.
3. Product Spotlights as product questions recur.
4. Customer Stories as real customer events complete (feeds the public project gallery ambition).
5. Videos / YouTube once written cadence is stable.
...
- Locked the page copy: hero, four doors, Field Notes section, and the contextual footer CTA ("See How the Hacks-a-Thon Works").
- Established the eight-article launch roadmap plus Field Notes cadence, the internal pillar taxonomy (Playbook reference corrected), and the post-launch roadmap with templates as the first gated addition.
